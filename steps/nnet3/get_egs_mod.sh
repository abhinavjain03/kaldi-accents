...
if [ $stage -le 3 ]; then
  ...
  $cmd $dir/log/create_valid_subset.log \
    ...
    scale-post ark:- "scp:/home/abhinav/kaldi/accents/australia_accents_train" ark:- \| \
    ali-to-post ark:- ark:- \| \
...
if [ $stage -le 4 ]; then
  ...
  $cmd JOB=1:$nj $dir/log/get_egs.JOB.log \
    ...
    "ark,s,cs:filter_scp.pl $sdata/JOB/utt2spk $dir/ali.scp | ali-to-pdf $alidir/final.mdl scp:- ark:- | scale-post ark:- scp:/home/abhinav/kaldi/accents/australia_accents_train ark:- | ali-to-post ark:- ark:- | " ark:- \| \
