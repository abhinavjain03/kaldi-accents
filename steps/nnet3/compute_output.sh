...
if $apply_exp; then
  output_wspecifier="ark:| copy-matrix --apply-exp ark:- ark,t:$dir/output.JOB.ark"
else
  output_wspecifier="ark:| copy-feats --compress=$compress ark:- ark,t:$dir/output.JOB.ark"
fi
